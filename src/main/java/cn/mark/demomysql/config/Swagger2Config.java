...
public class Swagger2Config {
    ...
    @Value("${swagger.termsOfServiceUrl:http://demomysql.mark.cn}")
    private String termsOfServiceUrl;

    @Value("${swagger.contact.name:mark}")
    private String name;

    @Value("${swagger.contact.url:http://mark.cn}")
    private String url;

    @Value("${swagger.contact.email:2408032134@qq.com}")
